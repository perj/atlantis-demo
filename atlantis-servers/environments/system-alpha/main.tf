...
output "atlantis_url" {
  description = "System Alpha Atlantis URL"
  value       = module.system_alpha_atlantis.atlantis_url
}

output "webhook_url" {
  description = "Webhook URL to configure in GitLab"
  value       = module.system_alpha_atlantis.webhook_url
}

output "webhook_secret" {
  description = "Webhook secret to configure in GitLab"
  value       = module.system_alpha_atlantis.webhook_secret
  sensitive   = true
}

output "gitlab_webhook_setup" {
  description = "Instructions for configuring the GitLab webhook"
  value       = module.system_alpha_atlantis.gitlab_webhook_setup
}
